...
dnl ---- EVAL dispatch ----
define(<<<ev_form>>>, <<<ifelse(len(<<<$1>>>), 0, E, <<<ev_d1(first_char(<<<$1>>>), <<<$1>>>)>>>)>>>)dnl
...
define(<<<ev_lb_scan>>>, <<<ifelse(len(<<<$1>>>), 0, E, <<<ev_lb_d(first_char(<<<$1>>>), <<<$1>>>)>>>)>>>)dnl
define(<<<ev_lb_d>>>, <<<ifelse(<<<$1>>>, RP, E, <<<ev_lb1(<<<$1>>>, <<<$2>>>)>>>)>>>)dnl
...
define(<<<ev_lb5>>>, <<<ev_token(E, <<<$1>>>)ev_list_apply(defn(<<<__SF_ELEM>>>), defn(<<<__SF_REST>>>))>>>)dnl
...
define(<<<ev_arith>>>, <<<eval(ev_as_scan(skip_ws(<<<$2>>>), <<<$1>>>, E))>>>)dnl
...
define(<<<ev_as5>>>, <<<ev_token(E, <<<$1>>>)ev_as_elem(defn(<<<__SF_ELEM>>>), defn(<<<__SF_REST>>>), <<<$2>>>, <<<$3>>>)>>>)dnl
...
define(<<<ev_vec_body>>>, <<<ev_vb_scan(skip_ws(<<<$1>>>), E)>>>)dnl
...
define(<<<ev_vb5>>>, <<<ev_token(E, <<<$1>>>)ev_vb_elem(defn(<<<__SF_ELEM>>>), defn(<<<__SF_REST>>>), <<<$2>>>)>>>)dnl
...
define(<<<ev_map_body>>>, <<<ev_mb_scan(skip_ws(<<<$1>>>), E)>>>)dnl
...
define(<<<ev_mb5>>>, <<<ev_token(E, <<<$1>>>)ev_mb_k(defn(<<<__SF_ELEM>>>), defn(<<<__SF_REST>>>), <<<$2>>>)>>>)dnl
define(<<<ev_mb_k>>>, <<<ev_mb_v(skip_ws(<<<$2>>>), <<<$3>>>, <<<$1>>>)>>>)dnl
define(<<<ev_mb_v>>>, <<<ifelse(len(skip_ws(<<<$1>>>)), 0, E, <<<ev_mv_d(first_char(skip_ws(<<<$1>>>)), skip_ws(<<<$1>>>), <<<$2>>>, <<<$3>>>)>>>)>>>)dnl
define(<<<ev_mv_d>>>, <<<ifelse(<<<$1>>>, <<<}>>>, E, <<<ev_mv1(<<<$1>>>, <<<$2>>>, <<<$3>>>, <<<$4>>>)>>>)>>>)dnl
...
define(<<<ev_mv5>>>, <<<ev_token(E, <<<$1>>>)ev_mb_join(<<<$3>>>, defn(<<<__SF_ELEM>>>), defn(<<<__SF_REST>>>), <<<$2>>>)>>>)dnl
