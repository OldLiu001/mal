...
define(<<<__PRINT>>>, <<<DEC(ev_form(defn(<<<__FORM>>>), defn(<<<__REPL_ENV>>>)))>>>)dnl
define(<<<REP>>>, <<<ifelse(defn(<<<__REPL_ENV>>>), __EE, <<<define(<<<__REPL_ENV>>>, env_new(__EE))>>>)__READ(<<<$1>>>)define(<<<__FORM>>>, defn(<<<__LAST_AST>>>))define(<<<__RES>>>, __PRINT())ifelse(__ERR, 1, <<<Error: >>>__ERRMSG, <<<defn(<<<__RES>>>)>>>)
>>>)dnl
...
define(<<<ev_form>>>, <<<dbg_eval(<<<$1>>>, <<<$2>>>)ifelse(len(<<<$1>>>), 0, __EE, <<<ev_d1(first_char(<<<$1>>>), <<<$1>>>, <<<$2>>>)>>>)>>>)dnl
...
define(<<<ev_la7>>>, <<<ifelse(<<<$1>>>, <<<list>>>, <<<ev_list_fn(<<<$2>>>, <<<$3>>>)>>>, <<<ev_la8(<<<$1>>>, <<<$2>>>, <<<$3>>>)>>>)>>>)dnl
define(<<<ev_la8>>>, <<<ifelse(<<<$1>>>, <<<list?>>>, <<<ev_listq(<<<$2>>>, <<<$3>>>)>>>, <<<ev_la9(<<<$1>>>, <<<$2>>>, <<<$3>>>)>>>)>>>)dnl
define(<<<ev_la9>>>, <<<ifelse(<<<$1>>>, <<<empty?>>>, <<<ev_emptyq(<<<$2>>>, <<<$3>>>)>>>, <<<ev_la10(<<<$1>>>, <<<$2>>>, <<<$3>>>)>>>)>>>)dnl
define(<<<ev_la10>>>, <<<ifelse(<<<$1>>>, <<<count>>>, <<<ev_count(<<<$2>>>, <<<$3>>>)>>>, <<<ev_la11(<<<$1>>>, <<<$2>>>, <<<$3>>>)>>>)>>>)dnl
define(<<<ev_la11>>>, <<<ifelse(<<<$1>>>, <<<=>>>, <<<ev_eq(<<<$2>>>, <<<$3>>>)>>>, <<<ev_la12(<<<$1>>>, <<<$2>>>, <<<$3>>>)>>>)>>>)dnl
define(<<<ev_la12>>>, <<<ifelse(<<<$1>>>, <<<<>>>, <<<ev_lt(<<<$2>>>, <<<$3>>>)>>>, <<<ev_la13(<<<$1>>>, <<<$2>>>, <<<$3>>>)>>>)>>>)dnl
define(<<<ev_la13>>>, <<<ifelse(<<<$1>>>, <<<<=>>>, <<<ev_le(<<<$2>>>, <<<$3>>>)>>>, <<<ev_la14(<<<$1>>>, <<<$2>>>, <<<$3>>>)>>>)>>>)dnl
define(<<<ev_la14>>>, <<<ifelse(<<<$1>>>, <<<>>>>, <<<ev_gt(<<<$2>>>, <<<$3>>>)>>>, <<<ev_la15(<<<$1>>>, <<<$2>>>, <<<$3>>>)>>>)>>>)dnl
define(<<<ev_la15>>>, <<<ifelse(<<<$1>>>, <<<>=>>>, <<<ev_ge(<<<$2>>>, <<<$3>>>)>>>, <<<ev_la16(<<<$1>>>, <<<$2>>>, <<<$3>>>)>>>)>>>)dnl
define(<<<ev_la16>>>, <<<env_get(<<<$3>>>, <<<$1>>>)>>>)dnl
dnl ---- def! ----
...
define(<<<ev_list_fn>>>, <<<ifelse(len(<<<$1>>>), 0, <<<()>>>, <<<(ev_lf_scan(skip_ws(<<<$1>>>), __EE, <<<$2>>>))>>>)>>>)dnl
...
define(<<<ev_cmp2a>>>, <<<define(<<<__C1>>>, ev_form(<<<$1>>>, <<<$4>>>))ev_cmp2b(defn(<<<__C1>>>), <<<$2>>>, <<<$3>>>, <<<$4>>>)>>>)dnl
